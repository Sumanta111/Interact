            ...
            <?= $res->desg;?>
				...
				<div class="profile-usermenu">
					<ul class="nav">
						...
						<li>
							<?= anchor('prof_profile/xx','&nbsp;Notify_Students',['class'=>'glyphicon glyphicon-user']);?>
						</li>
						<li>
							<?= anchor('prof_profile/xy','&nbsp;Upload_for_Students',['class'=>'glyphicon glyphicon-ok']);?>
						</li>
						<li>
							<?= anchor('prof_profile/xz','&nbsp;Message_History',['class'=>'glyphicon glyphicon-flag']);?>
						</li>
					</ul>
				</div>
			</div>
